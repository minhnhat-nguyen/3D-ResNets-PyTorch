...
from datasets.loader import VideoLoader, VideoLoaderFlowHDF5, VideoLoaderHDF5
...
def get_training_data(
    ...
    if file_type == "jpg":
        assert (
            input_type == "rgb"
        ), "flow input is supported only when input type is hdf5."
        ...
        video_path_formatter = (
            lambda root_path, label, video_id: root_path / label / f"{video_id}.hdf5"
        )
