...
def parse_opts():
    ...
    parser.add_argument(
        "--video_path", default=None, type=Path, help="Directory path of videos"
    )
    parser.add_argument(
        "--annotation_path", default=None, type=Path, help="Annotation file path"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=int,
        help=(
            "Number of classes of pretraining task."
            "When using --pretrain_path, this must be set."
        ),
    )
    parser.add_argument(
        "--pretrain_path", default=None, type=Path, help="Pretrained model path (.pth)."
    )
    parser.add_argument(
        "--ft_begin_module",
        default="",
        type=str,
        help=(
            "Module name of beginning of fine-tuning"
    ...
    parser.add_argument(
        ...
        type=str,
        help=(
            "Spatial cropping method in training. "
            "random is uniform. "
    ...
    parser.add_argument(
        "--colorjitter", action="store_true", help="If true colorjitter is performed."
    )
    parser.add_argument(
        "--train_t_crop",
        default="random",
        type=str,
        help=(
            "Temporal cropping method in training. "
            "random is uniform. "
            "(random | center)"
        ),
    )
    ...
    parser.add_argument(
        ...
        type=str,
        help=(
            "dataset for mean values of mean subtraction"
    ...
    parser.add_argument(
        "--optimizer", default="sgd", type=str, help="Currently supports SGD and Adam"
    )
    parser.add_argument(
        "--adam_learning_rate",
        default=0.0001,
    ...
    parser.add_argument(
        "--inference", action="store_true", help="If true, inference is performed."
    )
    parser.add_argument(
        "--inference_subset",
        default="val",
    ...
    parser.add_argument(
        ...
        type=str,
        help=(
            "Cropping method in inference. (center | nocrop)"
    ...
    parser.add_argument(
        ...
        default="resnet",
        type=str,
        help="(resnet | resnet2p1d | preresnet | wideresnet | resnext | densenet | efficientnet)",
    )
    parser.add_argument(
        "--model_depth",
        default=18,
    ...
    parser.add_argument(
        "--conv1_t_size", default=7, type=int, help="Kernel size in t dim of conv1."
    )
    parser.add_argument(
        "--conv1_t_stride", default=1, type=int, help="Stride in t dim of conv1."
    )
    parser.add_argument(
        "--no_max_pool",
        action="store_true",
    ...
    parser.add_argument("--input_type", default="rgb", type=str, help="(rgb | flow)")
    parser.add_argument(
    ...
    parser.add_argument("--file_type", default="jpg", type=str, help="(jpg | hdf5)")
    parser.add_argument(
        "--tensorboard",
        action="store_true",
