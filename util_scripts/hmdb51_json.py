...
def convert_hmdb51_csv_to_json(
    csv_dir_path, split_index, video_dir_path, dst_json_path
):
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "dst_dir_path", default=None, type=Path, help="Directory path of dst json file."
    )
    ...
    for split_index in range(1, 4):
        ...
        convert_hmdb51_csv_to_json(
            args.dir_path, split_index, args.video_path, dst_json_path
        )
